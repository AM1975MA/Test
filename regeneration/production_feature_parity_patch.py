...
def main():
    ap=argparse.ArgumentParser(); ap.add_argument('--base',type=Path,required=True); ap.add_argument('--v6',type=Path,required=True); a=ap.parse_args()
    patch_base(a.base); patch_v6(a.v6)
    print('patched',a.base,a.v6)
